...
namespace OSS.EventTask.Extension
{
    public static class SerialGroupExtension
    {
        ...
        //  顺序任务 回退当前任务之前所有任务
        internal static async Task Executing_SerialRevert<TTData, TTRes>(this IDictionary<BaseEventTask<TTData, TTRes>, EventTaskResp<TTRes>> taskResults, TTData data)
            where TTData : class
            //where TTRes : class, new()
        {
