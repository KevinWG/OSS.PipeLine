...
{
    public abstract class InterBaseEventTask<TMetaType, TTData, TResp> : BaseMeta<TMetaType>,IBufferTunnel<TTData,TResp>
        ...
        where TResp : BaseTaskResp<TMetaType>, new()
    {
        ...
        protected InterBaseEventTask()
        {
        }

        protected InterBaseEventTask(TMetaType meta) : base(meta)
        {
        }
